      ...
      <SectionOpacity classes="z-2">
        ...
        <div className="relative self-start px-[6vw] pb-[5vw] pt-[3vw] md:px-[3vw]">
          <div className="flex space-x-[5vw] md:flex-col md:items-center md:space-x-0 md:space-y-[3vw]">
            <p className="flex grow-[4] basis-0 flex-wrap text-[2.3vw] md:text-balance md:text-center md:text-[3.8vw] md:leading-[1.3]">
              We are a young, close-knit team of like-minded people ready to help brands from USA prosper in the digital
              world.
            </p>
