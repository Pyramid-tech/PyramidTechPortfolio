      ...
      >
        ...
        <div className="flex h-full flex-col justify-between">
          ...
          <Link
            ...
            className="flex w-full items-center justify-center gap-[0.6vw] rounded-sm bg-zinc-600 px-[0.6vw] py-[0.6vw] transition hover:bg-zinc-700/60 active:bg-zinc-700"
          >
            <svg className="h-[1.2vw] w-[1.2vw]" viewBox="0 0 438.549 438.549">
              <path
                fill="currentColor"
