...
export const First: FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg
    ...
    {...props}
  >
    <circle cx="8" cy="8.41406" r="8" fill="currentColor" />
    <circle cx="24" cy="24.4141" r="8" fill="currentColor" />
  </svg>
);
...
export const Fifth: FC<SVGProps<SVGSVGElement>> = (props) => (
  ...
  >
    <ellipse cx="12" cy="24" rx="8.99998" ry="8.99998" fill="currentColor" />
    <path d="M33 28L9.00002 4H33V28Z" fill="currentColor" />
  </svg>
);
