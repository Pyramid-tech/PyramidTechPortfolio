    ...
    <footer className="overflow-hidden border-t border-t-gray-1 px-6 pt-12 md:px-12">
      ...
      <div className="flex flex-col gap-8 sm:flex-row sm:justify-between">
        <div className="max-w-xs">
          <p className="text-sm leading-relaxed text-text-1/70 md:text-base">
            Smart, scalable products from first concept to production.
          </p>
          <a
            href={`mailto:${CONTACT_EMAIL}`}
            aria-label="Email us"
            className="group mt-4 inline-flex items-center gap-1.5 text-sm text-text-1 transition hover:text-text-strong md:text-base"
          >
            email
        ...
        <div className="flex flex-col gap-3 text-sm sm:items-end sm:text-right md:text-base">
          <span className="text-text-1/70">Beirut, Lebanon</span>
          <Link
            href="/book"
            className="group inline-flex items-center gap-1.5 text-text-1 transition hover:text-text-strong"
          >
            Start a project
            <span className="transition-transform duration-300 group-hover:translate-x-0.5">→</span>
          </Link>
      ...
      <div className="mt-8 flex items-center justify-between border-t border-t-stroke/60 py-6 text-xs text-text-1/50 md:text-sm">
